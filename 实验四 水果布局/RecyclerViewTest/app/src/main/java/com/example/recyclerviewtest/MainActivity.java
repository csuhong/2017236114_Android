...
public class MainActivity extends AppCompatActivity {
    ...
    private void initFruits() {
        for (int i = 0; i < 2; i++) {
            ...
            Fruit pear = new Fruit(getRandomLengthName("雪梨"), R.drawable.pear_pic);
            fruitList.add(pear);
            ...
            fruitList.add(mango);
            Fruit kiwi = new Fruit(getRandomLengthName("奇异果"), R.drawable.kiwi_pic);
            fruitList.add(kiwi);
            Fruit peach = new Fruit(getRandomLengthName("桃子"), R.drawable.peach_pic);
            fruitList.add(peach);
        }
    }
